...
object MockDataProvider {
    ...
    fun getMockProducts() = listOf(
        Product("1", "Wireless Headphones", "High-quality sound", 89.99, 129.99, "https://via.placeholder.com/200/FF6B6B/FFFFFF?text=Headphones", 4.5, 128, "1", "1"),
        Product("2", "Smart Watch", "Latest technology", 199.99, 299.99, "https://via.placeholder.com/200/4ECDC4/FFFFFF?text=Smart+Watch", 4.8, 256, "2", "1"),
        Product("3", "USB-C Cable", "Fast charging", 12.99, 19.99, "https://via.placeholder.com/200/45B7D1/FFFFFF?text=USB-C+Cable", 4.2, 89, "3", "1"),
        Product("4", "Portable Speaker", "Bluetooth 5.0", 49.99, 79.99, "https://via.placeholder.com/200/F7DC6F/FFFFFF?text=Speaker", 4.6, 145, "4", "1"),
    ...
    fun getMockProductDetail(productId: String): ProductDetail {
    ...
    fun getMockCartItems() = listOf(
        CartItem(
            ...
            price = 89.99,
            subtotal = 2 * 89.99,
            imageUrl = "https://via.placeholder.com/100/FF6B6B/FFFFFF?text=Headphones"
        ),
        CartItem(
            id = "2",
            productId = "product2",
            ...
            price = 199.99,
            subtotal = 1 * 199.99,
            imageUrl = "https://via.placeholder.com/100/4ECDC4/FFFFFF?text=Watch"
        )
    )
